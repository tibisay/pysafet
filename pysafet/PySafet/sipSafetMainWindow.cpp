...
extern "C" {static PyObject *meth_MainWindow_getCurrentRest(PyObject *, PyObject *);}
static PyObject *meth_MainWindow_getCurrentRest(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = NULL;

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_MainWindow, &sipCpp))
        {
            ...
            Py_BEGIN_ALLOW_THREADS
            sipRes = new QString(sipCpp->getCurrentRest());
            Py_END_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_MainWindow, sipName_getCurrentRest, NULL);

    return NULL;
}


extern "C" {static PyObject *meth_MainWindow_executeRest(PyObject *, PyObject *);}
static PyObject *meth_MainWindow_executeRest(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = NULL;

    {
        const QString* a0;
        int a0State = 0;
        const QString& a1def = "admin";
        const QString* a1 = &a1def;
        int a1State = 0;
        const QString& a2def = "admin";
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ1|J1J1", &sipSelf, sipType_MainWindow, &sipCpp, sipType_QString,&a0, &a0State, sipType_QString,&a1, &a1State, sipType_QString,&a2, &a2State))
        {
            ...
            Py_BEGIN_ALLOW_THREADS
            sipRes = new QString(sipCpp->executeRest(*a0,*a1,*a2));
            Py_END_ALLOW_THREADS
            sipReleaseType(const_cast<QString *>(a0),sipType_QString,a0State);
            sipReleaseType(const_cast<QString *>(a1),sipType_QString,a1State);
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_MainWindow, sipName_executeRest, NULL);
...
static PyMethodDef methods_MainWindow[] = {
    ...
    {SIP_MLNAME_CAST(sipName_executeRest), meth_MainWindow_executeRest, METH_VARARGS, NULL},
    ...
    {SIP_MLNAME_CAST(sipName_getCurrentRest), meth_MainWindow_getCurrentRest, METH_VARARGS, NULL},
